...
plt.loglog(ell_for_plot,cmbhd.Dl_N_uK2(150,ell_for_plot),label="CMB-HD 150GHz")
plt.ylim(1e-8,1e4)
plt.xlim(1,1e4)
...
plt.loglog(ell_for_plot,cmbhd.Cl_N_Jy2persr(150,ell_for_plot),label="CMB-HD 150GHz")
plt.ylim(1e-4,1e8)
plt.xlim(1,1e4)
